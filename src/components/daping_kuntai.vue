<template>
  <div class="hid">
    ...
    <el-row class="headrow">
      <el-col :span="2" class="nocenter" onclick="window.open('http://120.79.194.86:9527/','_self')" style="font-size:0.5em">
        <span>后台管理</span>
      </el-col>
       <el-col :span="5" class="xinjia">
        <span>2017年江苏省重点研发计划（现代农业）项目示范基地</span>
      </el-col>
      <el-col :span="10" >
    ...
    <el-row class="biaolan">
      <el-col :span="6" style="overflow:hidden;">
        <el-row class="zcb">
              ...
              <el-row :gutter="20" style="margin:1px">
                <el-col :span="8" v-for="i in tianqilist " :key="i.id" class="noborad">
                  <el-card class="box-card" style="color: rgb(51, 136, 255);">
                    <div slot="header">
                      <span style="font-size:0.8em">{{i.date}}</span>
                    </div>
                    <div>
                      <i :class="i.icon"></i>
                    </div>
          ...
          <el-col>
            <div v-loading="login2" class="xinwentotle">
              <span>实时行情</span>
            </div>
            <dv-scroll-board :config="config" style="width:100%;height:200px" v-if='hangqi'/>
          </el-col>
        </el-row>
      </el-col>
      <el-col :span="12" class="zj">
        <el-row>
          ...
          <el-col class="ditu">
            ...
            >
              <!-- 这里改变跳动的点的定位//lng:118.972209 lat31.810735-->
              <bm-marker
                :position="{lng: 118.972209, lat: 31.810735}"
                :dragging="true"
...
export default {
  ...
  data() {
    return {
      ...
      echartdata: [
        {
          title: "1号槽",
          codvalue: [2.2, 1.9, 1.7, 1.9, 3.7, 6.1, 8.2,8.6 , 9.0, 6.4,4.7, 3.7],
      ...
      config: {
        ...
        data: [
          ...
          ["2020-09-04", "甲鱼", "27/斤"],
          ["2020-09-04", "黑鱼", "10/斤"],
          ["2020-09-04", "鲈鱼", "17.5/斤"],
          ["2020-09-04", "罗飞", "3.2/斤"],
          ["2020-09-04", "海参", "82/斤"],
          ["2020-09-04", "鳜鱼", "31/斤"],
          ["2020-09-04", "草鱼", "6.6/斤"],
          ["2020-09-04", "鲤鱼", "5/斤"],
          ["2020-09-04", "黄颡", "11.5/斤"],
          ["2020-09-04", "鲫鱼", "8.5/斤"],
          ["2020-09-04", "螃蟹", "26/斤"],
          ["2020-09-04", "鲶鱼", "6.2/斤"],
          ["2020-09-04", "龙虾", "22/斤"],
  ...
  methods: {
    ...
    async tianqipc() {
      ...
      if (data) {
        ...
        for(let i=0;i<datalist.length;i++){
          ...
          break;
          case datalist[i].icon==="d01"||datalist[i].icon==="d02"||datalist[i].icon==="png40":
    ...
    handler({ BMap, map }) {
      ...
      (this.center.lng = 118.972209),
        (this.center.lat = 31.810735),
        (this.zoom = 17);
    },
    //实时数据部分改变标号进行的函数
    sizechangeA(data) {
